...
import usePurchaseOrders from "../../composables/purchase/usePurchaseOrders";
import usePurchaseMutations from "../../composables/purchase/usePurchaseOrderMutations";
...
const selectedPurchase = ref<PurchaseOrder>({} as PurchaseOrder);
...
const onAcept = (purchase: PurchaseOrder) => {
...
<template>
  <UIScaffold title="Ordenes Compras">
...
<style scoped></style>
../../models/PurchaseOrder../../models/PurchaseOrder
../../composables/purchase/usePurchaseOrderMutations
../../composables/purchase/usePurchaseOrders
